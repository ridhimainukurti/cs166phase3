...
<<<<<<< HEAD
DROP INDEX IF EXISTS idx_username_login;
DROP INDEX IF EXISTS idx_userid_login;
...
CREATE INDEX idx_username_login ON Login(userName);
CREATE INDEX idx_userid_login ON Login(userID);
=======
CREATE INDEX idx_pilotid_maintenancerequest ON MaintenanceRequest(PilotID);
>>>>>>> refs/remotes/origin/main
